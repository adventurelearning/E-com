...
function Payment_Policy() {
  ...
  useEffect(() => {
    Api.get("/paymentpolicy")
      ...
      .catch((err) => {
        console.log(err);
        setError("Failed to load payment policy. Please try again later.");
        setLoading(false);
      });
  }, []);
          ...
          >
            ...
            <div className="bg-gray-100 p-6 border-t border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                If you have any questions about our payment policy, please contact our support team.
              </p>
