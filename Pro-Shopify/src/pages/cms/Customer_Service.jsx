...
function Customer_Service() {
  ...
  useEffect(() => {
    Api.get("/customer_service")
      ...
      .catch((err) => {
        console.log(err);
        setError("Failed to load customer service information. Please try again later.");
        setLoading(false);
      });
  }, []);
          ...
          >
            ...
            <div className="bg-gray-100 p-6 border-t border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                If you have any questions about our customer service, please contact our support team.
              </p>
